...
const News = (props)=>{
    ...
    const updateNews = async ()=> {
        ...
        const url = `http://api.mediastack.com/v1/news?access_key=${props.apiKey}&countries=${props.country}&categories=${props.category}&offset=${page}&limit=${props.pageSize}&languages=en&sort=published_desc`; 
        setLoading(true)
